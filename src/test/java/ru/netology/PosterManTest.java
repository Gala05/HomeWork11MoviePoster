...
public class PosterManTest {
    ...
    @Test
    public void findByIdTest() { //вывод всех по списку
        PosterRepository repo = new PosterRepository();
        PosterManager manager = new PosterManager(repo);
        Poster movie1 = new Poster(1, "film1", "animated film", "imageUrl1");
        Poster movie2 = new Poster(2, "film2", "action movie", "imageUrl2");
        ...
        Poster[] actual = new Poster[]{repo.findById(3)};

        Assertions.assertArrayEquals(expected, actual);
    }
    @Test
    public void findByIdTestNegative() { //вывод всех по списку
        PosterRepository repo = new PosterRepository();
        PosterManager manager = new PosterManager(repo);
        Poster movie1 = new Poster(1, "film1", "animated film", "imageUrl1");
        Poster movie2 = new Poster(2, "film2", "action movie", "imageUrl2");
        ...
        Poster[] actual = new Poster[]{repo.findById(6)};
    ...
    /*
        @Test
    public void getPostersInReverseAll() { //вывод всех фильмов в обратном порядке он проходит! чтобы не мешал
        PosterRepository repo = new PosterRepository();
        PosterManager manager = new PosterManager(repo);
        Poster movie1 = new Poster(1, "film1", "animated film", "imageUrl1");
        Poster movie2 = new Poster(2, "film2", "action movie", "imageUrl2");
